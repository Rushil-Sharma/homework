...
if x == 'no' or x == 'nope' or x == 'nah':
    os.system(f'pip install pygame')
    print('') 
    time.sleep(5)
    os.system('cls')
    sys.exit(0)
print('ok loading ...')
input("Rules:\n     Each player gets to choose a name\n     This game end's when some player wins\n     When a player selects the button the button can't be reclicked \nPlease read the above rules and clicked enter :")
tk = Tk()
...
label = Label( tk, text="Name X", font='Times 20 bold', bg='light blue', fg='black', height=1, width=8)
label.grid(row=1, column=0)


label = Label( tk, text="Name O", font='Times 20 bold', bg='light blue', fg='black', height=1, width=8)
